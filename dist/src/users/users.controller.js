...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Listar usuarios (admin)' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(guards_1.RolesGuard),
    (0, decorators_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Asignar rol a usuario (admin)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.AssignRoleDto]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "assignRole", null);
__decorate([
    (0, common_1.Delete)(':id/roles/:roleCode'),
    (0, common_1.UseGuards)(guards_1.RolesGuard),
    (0, decorators_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Remover rol de usuario (admin)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
